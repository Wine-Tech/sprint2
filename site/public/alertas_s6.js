...
// }
function alertar_s6(temperatura,umidade, idLocal) {
...
// var temperatura = resposta[0].temperatura;
    ...
    if (temperatura >= limiteTemperatura.criticoQuente) {
        ...
        exibirAlerta_s6(temperatura, idLocal, grauDeAviso, grauDeAvisoCor)
        divTempAlerta_s6.style.background = 'rgb(255, 0, 0)'
    }
        ...
        // valorCritico = true
        exibirAlerta_s6(temperatura, idLocal, grauDeAviso, grauDeAvisoCor)
        divTempAlerta_s6.style.background = 'rgb(253, 148, 0)'
        ...
        // valorCritico = true
        exibirAlerta_s6(temperatura, idLocal, grauDeAviso, grauDeAvisoCor)
        divTempAlerta_s6.style.background = 'rgb(63, 151, 210)';
    }
        ...
        // valorCritico = true
        exibirAlerta_s6(temperatura, idLocal, grauDeAviso, grauDeAvisoCor)
        divTempAlerta_s6.style.background = 'rgb(54, 44, 238)'
    }
    ...
    if (umidade >= limiteUmidade.criticoUmidadeAlta) {
        ...
        // valorCritico = true
        exibirAlerta1_s6( umidade, idLocal, grauDeAviso, grauDeAvisoCor)
        divUmidAlerta_s6.style.background = 'rgb(255, 0, 0)'
        ...
        // valorCritico = true
        exibirAlerta1_s6( umidade, idLocal, grauDeAviso, grauDeAvisoCor)
        divUmidAlerta_s6.style.background = 'rgb(63, 151, 210)'
        ...
        // valorCritico = true
        exibirAlerta1_s6( umidade, idLocal, grauDeAviso, grauDeAvisoCor)
        divUmidAlerta_s6.style.background = 'rgb(54, 44, 238)'
    }
...
function exibirAlerta_s6(temperatura, idLocal, grauDeAviso, grauDeAvisoCor) {
    var indice = alertas_s6.findIndex(item => item.idLocal == idLocal);
    console.log('cheguei',indice);
    if (indice >= 0) {
        alertas_s6[indice] = { idLocal, temperatura, grauDeAviso, grauDeAvisoCor }
    } else {
        alertas_s6.push({ idLocal, temperatura, grauDeAviso, grauDeAvisoCor });
    }
...
function exibirAlerta1_s6(umidade, idLocal, grauDeAviso, grauDeAvisoCor) {
    var indice2 = alertas_s6.findIndex(item => item.idLocal == idLocal);
    console.log('cheguei',indice2);
    if (indice2 >= 0) {
        alertas_s6[indice2] = { idLocal, umidade, grauDeAviso, grauDeAvisoCor}
    } else {
        alertas_s6.push({ idLocal, umidade, grauDeAviso, grauDeAvisoCor});
    }
    exibirCards1_s6()
}

function removerAlerta_s6(idLocal) {
    alertas_s6 = alertas_s6.filter(item => item.idLocal != idLocal);
    exibirCards_s6();
}
function removerAlerta1_s6(idLocal) {
    alertas_s6 = alertas_s6.filter(item => item.idLocal != idLocal);
    exibirCards1_s6();
}

function exibirCards_s6() {
    alerta6.innerHTML = '';

    for (var i = 0; i < alertas_s6.length; i++) {
        var mensagem2 = alertas_s6[i];
        ...
        alerta6.innerHTML += transformarEmDiv_s6(mensagem2);
    }
}
function exibirCards1_s6() {
    alerta7.innerHTML = '';

    for (var i = 0; i < alertas_s6.length; i++) {
        var mensagem3 = alertas_s6[i];
        divNotificacao.innerHTML = `
        <div class="notific">Alerta!<br> Existem armazéns que precisam de atenção.<br>Clique nesta notificação para visualizar
        <div class="alarme-sino"></div><div>`
        alerta7.innerHTML += transformarEmDiv2_s6(mensagem3);
    }
}

function transformarEmDiv_s6({ idLocal, temperatura, grauDeAviso, grauDeAvisoCor }) {
    return `<div id="divTempAlerta_s6" class="mensagem-alarme">
    <div id="infTempAlerta_s6" class="informacao">
...
function transformarEmDiv2_s6({idLocal, umidade,grauDeAviso,grauDeAvisoCor}) {
    return `<div id="divUmidAlerta_s6" class="mensagem-alarme1">
    <div id="infUmidAlerta_s6" class="informacao"> 
