var localSensorModel = require("../models/localSensorModel");
...
//         localSensorModel.entrar(email, senha)
//             .then(
//                 function (resultado) {
...
function cadastrar(req, res) {
    ...
    if (nomeLocal == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo localSensorModel.js
        localSensorModel.cadastrar(nomeLocal,descricao,tamanho)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
